...
<div class="main-login">
    ...
    <img src="estacionamento.svg" class="img-login" alt="estacionameno">
    ...
    <div class="direita-login">
        ...
        <div class="container-sm">
                ...
                <div class="textfield">
                    ...
                    <button type="button" id="bt3" class="btn btn-secondary"  onclick="mostrarSenha()"><img id="img1" src="olho.png" ></button>
                    </div>
                </div><br><br>
        ...
        <a href='https://test124578.000webhostapp.com/TCC/cadastro.php'><button class="btn btn-warning btn-sm" id="bt2">Cadastre-se aqui</button></a>
...
if(isset($_POST['n']) || isset($_POST['s'])){
    ...
    if(strlen($_POST['n']) == 0 ){
        ...
        if($result->num_rows === 1){
            ...
            echo '<script>window.location.replace("https://test124578.000webhostapp.com/TCC/inicio.php");</script>';
